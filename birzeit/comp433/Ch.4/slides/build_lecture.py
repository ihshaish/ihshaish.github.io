...
slide('''<h2>Part 1 &middot; Use case diagrams</h2>
<p class="lead">The first model in analysis: <em>who</em> uses the system and <em>what</em> they can do. We build it from the requirements, then detail and refine it.</p>
<div class="two">
  <div class="box"><h3>The diagram</h3><ul><li>What it is, and when to draw it</li><li>Actors, and how to find them (users, external systems, time)</li><li>Use cases, and how to find them (noun-verb analysis)</li><li>Building blocks and the system boundary</li></ul></div>
  <div class="box"><h3>Refining and detailing</h3><ul><li><code>&lt;&lt;include&gt;&gt;</code>, <code>&lt;&lt;extend&gt;&gt;</code>, generalisation, extension points</li><li>Composite (multi-level) use cases</li><li>The use case description, the contract behind the ellipse</li><li>Scenarios: normal, alternative, error</li></ul></div>
</div>
<div class="key"><span class="tag">Goal</span><p>Read a narrative and draw a correct, fully-refined use case diagram, then write the description and scenarios behind it.</p></div>''')
...
<table class="rel">
  ...
  <tbody>
    <tr><td><code>&lt;&lt;include&gt;&gt;</code></td><td>The base use case <strong>always</strong> performs the included sub-task. Factor it out to avoid repetition.</td><td>base &rarr; included</td></tr>
    <tr><td><code>&lt;&lt;extend&gt;&gt;</code></td><td>An <strong>optional / conditional</strong> behaviour that fires only when a guard at an extension point holds.</td><td>extension &rarr; base</td></tr>
...
slide('''<h2>Composite use cases: drilling down a level</h2>
<p class="lead">When one ellipse really stands for several tasks, draw it as a <strong>composite use case</strong> (the small grid marker) at the top level and <strong>expand it in a lower-level diagram</strong>. A deep system can add a 2nd level under a 1st-level composite, exactly how Adel decomposes <em>Manage patient registration</em>.</p>
<svg viewBox="0 0 920 330" class="ref" role="img" aria-label="A composite use case Manage room inventory expands into a lower-level diagram with Add room, Update rate, Set availability and Remove room."><defs><marker id="cmx" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="9" markerHeight="9" orient="auto"><path d="M0 0 L10 5 L0 10 Z" fill="#0f1419"/></marker></defs><text x="200" y="22" text-anchor="middle" class="lab">Top level</text><rect x="95" y="34" width="210" height="150" rx="6" fill="#faf7f2" stroke="#0f1419" stroke-width="1.4"/><g transform="translate(18,86)"><circle cx="16" cy="6" r="7" stroke="#2c6e9a" stroke-width="1.4" fill="#eaf3f9"/><line x1="16" y1="13" x2="16" y2="34" stroke="#4a8bb8" stroke-width="1.4"/><line x1="16" y1="18" x2="6" y2="26" stroke="#4a8bb8" stroke-width="1.4"/><line x1="16" y1="18" x2="26" y2="26" stroke="#4a8bb8" stroke-width="1.4"/><line x1="16" y1="34" x2="6" y2="46" stroke="#4a8bb8" stroke-width="1.4"/><line x1="16" y1="34" x2="26" y2="46" stroke="#4a8bb8" stroke-width="1.4"/><text x="16" y="62" text-anchor="middle" class="lab">Manager</text></g><line x1="50" y1="98" x2="128" y2="106" stroke="#4a8bb8" stroke-width="1.4"/><ellipse cx="205" cy="106" rx="80" ry="27" class="uml-box"/><text x="205" y="102" text-anchor="middle" class="uml-text">Manage room</text><text x="205" y="117" text-anchor="middle" class="uml-text">inventory</text><rect x="262" y="119" width="13" height="13" fill="none" stroke="#0f1419" stroke-width="1.1"/><line x1="268.5" y1="119" x2="268.5" y2="132" stroke="#0f1419" stroke-width="1.1"/><line x1="262" y1="125.5" x2="275" y2="125.5" stroke="#0f1419" stroke-width="1.1"/><text x="378" y="100" text-anchor="middle" class="lab">expands to</text><line x1="320" y1="110" x2="436" y2="110" stroke="#0f1419" stroke-width="1.5" marker-end="url(#cmx)"/><text x="645" y="22" text-anchor="middle" class="lab">1st level: Manage room inventory</text><rect x="455" y="34" width="380" height="284" rx="6" fill="#faf7f2" stroke="#0f1419" stroke-width="1.4"/><ellipse cx="615" cy="80" rx="86" ry="22" class="uml-box"/><text x="615" y="84" text-anchor="middle" class="uml-text">Add room</text><ellipse cx="615" cy="142" rx="86" ry="22" class="uml-box"/><text x="615" y="146" text-anchor="middle" class="uml-text">Update rate</text><ellipse cx="615" cy="204" rx="86" ry="22" class="uml-box"/><text x="615" y="208" text-anchor="middle" class="uml-text">Set availability</text><ellipse cx="615" cy="266" rx="86" ry="22" class="uml-box"/><text x="615" y="270" text-anchor="middle" class="uml-text">Remove room</text><g transform="translate(852,150)"><circle cx="16" cy="6" r="7" stroke="#2c6e9a" stroke-width="1.4" fill="#eaf3f9"/><line x1="16" y1="13" x2="16" y2="34" stroke="#4a8bb8" stroke-width="1.4"/><line x1="16" y1="18" x2="6" y2="26" stroke="#4a8bb8" stroke-width="1.4"/><line x1="16" y1="18" x2="26" y2="26" stroke="#4a8bb8" stroke-width="1.4"/><line x1="16" y1="34" x2="6" y2="46" stroke="#4a8bb8" stroke-width="1.4"/><line x1="16" y1="34" x2="26" y2="46" stroke="#4a8bb8" stroke-width="1.4"/><text x="16" y="62" text-anchor="middle" class="lab">Manager</text></g><line x1="852" y1="156" x2="703" y2="84" stroke="#4a8bb8" stroke-width="1.4"/><line x1="852" y1="156" x2="703" y2="144" stroke="#4a8bb8" stroke-width="1.4"/><line x1="852" y1="156" x2="703" y2="204" stroke="#4a8bb8" stroke-width="1.4"/><line x1="852" y1="156" x2="703" y2="264" stroke="#4a8bb8" stroke-width="1.4"/></svg>
<div class="key"><span class="tag">Key</span><p>The grid marker says "described by its own diagram". Use it to keep the top level readable; do not hide weak analysis behind it, every sub-use-case must still be a real, verb-named task.</p></div>''')
...
slide('''<h2>Part 2 &middot; Activity diagrams</h2>
<p class="lead">Where the use case diagram says <em>what</em>, the activity diagram says <em>how it flows</em>: the order of work, the decisions, the parallel steps, and who does each. We learn the notation, then build one from a use case.</p>
<div class="two">
  <div class="box"><h3>The notation</h3><ul><li>Initial / final nodes, and actions</li><li>Decision / merge and fork / join, and how each pair must close</li><li>Swimlanes (hand-offs) and loops (repeat / retry)</li></ul></div>
  <div class="box"><h3>Putting it together</h3><ul><li>From a use case description to a flow</li><li>Two granularities: one use case, or a whole business process</li><li>A second worked domain, end to end</li></ul></div>
</div>
<div class="key"><span class="tag">Goal</span><p>Take one use case and draw a well-formed flow: decisions closed by merges, forks by joins, every path reaching a final node.</p></div>''')
...
<ul class="pts"><li>Draw one when a use case has real <strong>decisions</strong>, <strong>parallelism</strong>, or <strong>several actors</strong>, not for a simple linear path.</li><li>One activity diagram per use case is the usual granularity, but a higher-level one can model a <strong>whole business process</strong> spanning several use cases (next slide).</li><li>It is also an elicitation tool: it surfaces use cases and steps the static view missed.</li></ul>''')
...
<div class="key"><span class="tag">Key &middot; they must close</span><p>Every <strong>decision</strong> is closed by a matching <strong>merge</strong> and every <strong>fork</strong> by a matching <strong>join</strong>; an opening diamond or bar with no closing one is the most common ill-formed-flow error. And every path must reach a final node, the flow must not get "stuck".</p></div>''')

slide('''<h2>Activity notations: parallel work and choices</h2>
<p class="lead">Fork and join for steps that run at once; decision and merge for a choice. The pairing is the point: a <strong>fork is always closed by a join</strong>, and a <strong>decision by a merge</strong>. Step through the builder and watch each pair open and then close.</p>
...
<p class="lead">Now apply all of it. The Book room use case, unpacked into a flow: each step of its description lights up as the matching action appears; the description's <strong>alternative flows</strong> become the diagram's <strong>decision branches and loops</strong>, and swimlanes assign each step to the Guest, the system, or the external provider.</p>
<iframe class="embed" allowfullscreen src="poc_activity_build.html" title="Activity build"></iframe>''')

slide('''<h2>The other granularity: a whole business process</h2>
<p class="lead">An activity diagram is not limited to one use case. At the <strong>business-process level</strong> it composes several use cases into a single flow. Here <em>Book a journey</em> runs three reservations in parallel, each its own use case, with a retry loop on the car.</p>
<svg viewBox="0 0 820 462" class="ref" role="img" aria-label="Book a journey business process: choose dates, then reserve flight, hotel and car in parallel, with a retry loop on the car, joined before confirming the trip."><defs><marker id="bpArrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto"><path d="M 0 0 L 10 5 L 0 10 Z" fill="#0f1419"/></marker></defs><circle cx="410" cy="36" r="9" fill="#0f1419"/><line x1="410" y1="45" x2="410" y2="66" class="uml-line" marker-end="url(#bpArrow)"/><rect x="325" y="70" width="170" height="38" rx="19" class="uml-box"/><text x="410" y="93" text-anchor="middle" class="uml-text">Choose trip dates</text><line x1="410" y1="108" x2="410" y2="132" class="uml-line" marker-end="url(#bpArrow)"/><rect x="180" y="135" width="460" height="6" rx="2" fill="#2c3540"/><line x1="230" y1="141" x2="230" y2="167" class="uml-line" marker-end="url(#bpArrow)"/><line x1="410" y1="141" x2="410" y2="167" class="uml-line" marker-end="url(#bpArrow)"/><line x1="590" y1="141" x2="590" y2="167" class="uml-line" marker-end="url(#bpArrow)"/><rect x="160" y="170" width="140" height="38" rx="19" class="uml-box"/><text x="230" y="193" text-anchor="middle" class="uml-text">Reserve flight</text><rect x="340" y="170" width="140" height="38" rx="19" class="uml-box"/><text x="410" y="193" text-anchor="middle" class="uml-text">Reserve hotel</text><rect x="520" y="170" width="140" height="38" rx="19" class="uml-box"/><text x="590" y="193" text-anchor="middle" class="uml-text">Reserve car</text><line x1="230" y1="208" x2="230" y2="318" class="uml-line" marker-end="url(#bpArrow)"/><line x1="410" y1="208" x2="410" y2="318" class="uml-line" marker-end="url(#bpArrow)"/><line x1="590" y1="208" x2="590" y2="232" class="uml-line" marker-end="url(#bpArrow)"/><polygon points="590,234 646,262 590,290 534,262" class="uml-box"/><text x="590" y="258" text-anchor="middle" class="uml-text" font-size="10">car</text><text x="590" y="270" text-anchor="middle" class="uml-text" font-size="10">available?</text><polyline points="646,262 700,262 700,189 662,189" class="uml-line" fill="none" marker-end="url(#bpArrow)"/><text x="706" y="240" text-anchor="start" class="uml-text" font-size="11">[no]</text><line x1="590" y1="290" x2="590" y2="318" class="uml-line" marker-end="url(#bpArrow)"/><text x="600" y="312" text-anchor="start" class="uml-text" font-size="11">[yes]</text><rect x="180" y="321" width="460" height="6" rx="2" fill="#2c3540"/><line x1="410" y1="327" x2="410" y2="353" class="uml-line" marker-end="url(#bpArrow)"/><rect x="335" y="356" width="150" height="38" rx="19" class="uml-box"/><text x="410" y="379" text-anchor="middle" class="uml-text">Confirm trip</text><line x1="410" y1="394" x2="410" y2="417" class="uml-line" marker-end="url(#bpArrow)"/><circle cx="410" cy="430" r="9" fill="white" stroke="#0f1419" stroke-width="1.4"/><circle cx="410" cy="430" r="5" fill="#0f1419"/></svg>
<div class="key"><span class="tag">Key</span><p>Same notation, wider scope. Pick <strong>one granularity per diagram</strong>: a single use case, or a whole process, not both. The process view often drops swimlanes, the focus is order and concurrency.</p></div>''')
...
import json
slides_html="".join(f'<section class="slide">{s}</section>\n' for s in SLIDES)
N=len(SLIDES)
HTML=f'''<!DOCTYPE html>
<html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1">
<title>COMP433 Ch.4 - UML: Use Case &amp; Activity Diagrams</title>
...
<style>
  ...
  * {{ box-sizing:border-box; }}
  ...
  svg.ref .uml-box {{ fill:#fff; stroke:var(--ink); stroke-width:1.4; }}
  svg.ref .uml-line {{ fill:none; stroke:var(--ink); stroke-width:1.4; }}
  svg.ref .uml-text {{ font-family:var(--sans); font-size:13px; fill:var(--ink); }}
  .embed {{ width:100%; height:86vh; border:1px solid var(--rule); border-radius:12px; background:#fff; margin-top:10px; }}
  ...
  .nav button {{ background:var(--steel); color:#fff; border:none; padding:10px 18px; border-radius:7px; font-family:var(--mono); font-size:12px; letter-spacing:.06em; text-transform:uppercase; font-weight:600; cursor:pointer; }}
...
{slides_html}  </div>
  <div class="nav">
    ...
    <span class="title-mini" id="tmini"></span>
...
let i=0;
function titleOf(s){{ const h=s.querySelector('h1,h2'); return h?h.textContent:''; }}
function show(){{
  slides.forEach((s,k)=>s.classList.toggle('active',k===i));
  document.getElementById('prev').disabled=i===0;
  document.getElementById('next').disabled=i===N-1;
  document.getElementById('count').textContent=(i+1)+' / '+N;
  document.getElementById('tmini').textContent=titleOf(slides[i]);
  document.getElementById('slidewrap').scrollTop=0;
}}
document.getElementById('prev').onclick=()=>{{ if(i>0){{i--;show();}} }};
document.getElementById('next').onclick=()=>{{ if(i<N-1){{i++;show();}} }};
window.addEventListener('keydown',e=>{{ if(e.key==='ArrowRight'||e.key==='PageDown'){{ if(i<N-1){{i++;show();}} }} else if(e.key==='ArrowLeft'||e.key==='PageUp'){{ if(i>0){{i--;show();}} }} }});
show();
</script>
</body></html>'''
